...
public  abstract class DataModelDatabase extends RoomDatabase {
    ...
    private static class PopulateData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            daodatamodel.insertProgress(new DataModel(1, 0, 0,"النهاردة اعملى لطفلك الاكل الى يحبه و قوليله انك فخورة بيه",R.drawable.lightpista));
            ...
            daodatamodel.insertProgress(new DataModel(8, 0, 0,"النهاردة اذهبى مع طفلك الى سينما لمشاهدة الكارتون او التنزة بحديقه",R.drawable.light_yellow_bg));

            daodatamodel.insertProgress(new DataModel(9, 0, 0,"النهاردة خلى طفلك يساعدك باعداد الطعام و اقضو وقت ممتع ",R.drawable.light_skin_bg));

            daodatamodel.insertProgress(new DataModel(10, 0, 0,"النهاردةشغلى موسيقى ممتعه للاطفال و شاركى طفلك الرقص",R.drawable.light_peach_bg));

            daodatamodel.insertProgress(new DataModel(11, 0, 0,"النهاردة فاجئى طفلك بهديه مثلا لعبه صغيرة ",R.drawable.light_blue_bg));

            daodatamodel.insertProgress(new DataModel(12, 0, 0,"النهاردة اذهبى مع طفلك لشراء مستلزمات المنزل و تبادلا الحديث الممتع ",R.drawable.light_purple));

            daodatamodel.insertProgress(new DataModel(13, 0, 0,"النهاردة التقطى صور كثيرة مرحه مع طفلك ",R.drawable.light_skin_bg));

            daodatamodel.insertProgress(new DataModel(14, 0, 0,"النهاردةقبلى طفلك كتيرا على جبهته و اخبريه انه افضل هديه من ربنا",R.drawable.light_yellow_bg));

            daodatamodel.insertProgress(new DataModel(15, 0, 0,"النهاردةتحدثى مع طفلك عن اكثر الاشياء التى تضايقه منك و خاولى اجتنابها",R.drawable.lightpista));
            ...
            daodatamodel.insertProgress(new DataModel(17, 0, 0,"النهاردة العبى مع طفلك لعبه حرب المخدات ",R.drawable.light_skin_bg));

            daodatamodel.insertProgress(new DataModel(18, 0, 0,"النهاردة اتكلمى مع طفلك و اخبريه عن اكتر صفه تحبيها فيه",R.drawable.light_purple));

            daodatamodel.insertProgress(new DataModel(19, 0, 0,"النهاره ضعى صورة تجمعكما سويا فى غرفته",R.drawable.light_blue_bg));

            daodatamodel.insertProgress(new DataModel(20, 0, 0,"النهاردة شاركى طفلك النوم بغرفه لمرة شهريا",R.drawable.light_skin_bg));
            ...
            daodatamodel.insertProgress(new DataModel(22, 0, 0,"النهاردة اعملى فشار و اتفرجى مع طفلك على كارتونه المفضل",R.drawable.lightpista));

            daodatamodel.insertProgress(new DataModel(23, 0, 0,"النهاردة شاركى طفلك رياضته المفضله مثل لعب كرة القدم سويا",R.drawable.light_skin_bg));

            daodatamodel.insertProgress(new DataModel(24, 0, 0,"النهاردة خلى طفلك يشاركك تصفيف شعرك او وضع الميكاب الخاص بكى",R.drawable.light_purple));

            daodatamodel.insertProgress(new DataModel(25, 0, 0,"النهاردة خلى طفلك يشاركك فى تقديم عمل خيرى كمساعدة احد المحتاجين ماديا",R.drawable.light_blue_bg));

            daodatamodel.insertProgress(new DataModel(26, 0, 0,"النهاردة قومى انت و طفلك بترتيب اغراضه و لعبه ",R.drawable.light_peach_bg));

            daodatamodel.insertProgress(new DataModel(27, 0, 0,"النهاردة اعملى تورته منزليه بمساعدة طفلك و احتفلو سوا",R.drawable.lightpista));
            ...
            daodatamodel.insertProgress(new DataModel(30, 0, 0,"النهاردشاركى طفلك لعبه عالكمبيوتر او عالموبايل مع الضحك سويا ",R.drawable.light_peach_bg));
